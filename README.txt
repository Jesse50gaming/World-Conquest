...
This is the readme for World Conquest, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. WorldConquest) > Ok.
...
- To run the project find WorldConquest.java (which will be in under src/main/java/com/worldconquest) and right click > Run 'WorldConquest'
